...
Theme often overwrites what is above it, so if you want to keep something write below theme
...
Character vectors are transformed into factors. So ggplot makes Name a factor with label 1, and puts it into alphabetical order. So let's manipulate df and not in ggplot
