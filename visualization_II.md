...
Dont use the TABLE function, it’s just bad cause it doesnt prduce a df
...
This is a dataframe, so we can make a plot easily
...
<img src="visualization_II_files/figure-gfm/unnamed-chunk-10-1.png" width="90%" />
...
Reminder, that sometimes results are easier to read in another format
...
If you want to spit out just one number responses thats mroe complicated
